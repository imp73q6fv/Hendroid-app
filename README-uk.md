...
##### `Hendroid` — це безкоштовний додаток з відкритим вихідним кодом для завантаження та перегляду додзінсі та хентай-манґи.
###### `Hendroid` підтримує:
...
Hendroid — це відгалуження (форк) популярного додатку: [Hentoid](https://github.com/avluis/Hentoid).
З нього видалені **всі метрики і відстеження**, а також механізм оновлення, тому що додаток передбачається оновлювати за допомогою F-Droid. Воно доступне в [**основному репозиторії F-Droid**](https://f-droid.org/uk/packages/org.nonononoki.hendroid).

Щоб уникнути плутанини, назва та іконка додатку змінені. Всі права належать розробникам вихідного проекту.
