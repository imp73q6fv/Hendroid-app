...
public final class GroupItem_ implements EntityInfo<GroupItem> {
    ...
    public static final RelationInfo<GroupItem, Content> content =
            new RelationInfo<>(GroupItem_.__INSTANCE, Content_.__INSTANCE, contentId, new ToOneGetter<GroupItem>() {
                @Override
    ...
    public static final RelationInfo<GroupItem, Group> group =
            new RelationInfo<>(GroupItem_.__INSTANCE, Group_.__INSTANCE, groupId, new ToOneGetter<GroupItem>() {
                @Override
