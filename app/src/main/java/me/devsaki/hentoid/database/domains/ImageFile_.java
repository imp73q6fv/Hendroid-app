...
public final class ImageFile_ implements EntityInfo<ImageFile> {
    ...
    public static final RelationInfo<ImageFile, Content> content =
            new RelationInfo<>(ImageFile_.__INSTANCE, Content_.__INSTANCE, contentId, new ToOneGetter<ImageFile>() {
                @Override
    ...
    public static final RelationInfo<ImageFile, Chapter> chapter =
            new RelationInfo<>(ImageFile_.__INSTANCE, Chapter_.__INSTANCE, chapterId, new ToOneGetter<ImageFile>() {
                @Override
