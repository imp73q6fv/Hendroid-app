...
public final class ContentCursor extends Cursor<Content> {
    ...
    public long put(Content entity) {
        ...
        long __assignedId = collect313311(cursor, entity.getId(), PUT_FLAG_COMPLETE,
                0, null, 0, null,
                0, null, 0, null,
                __ID_size, entity.getSize(), __ID_contentToReplaceId, entity.getContentToReplace().getTargetId(),
                __ID_completed, entity.isCompleted() ? 1 : 0, __ID_manuallyMerged, entity.isManuallyMerged() ? 1 : 0,
                __ID_isBeingDeleted, entity.isBeingDeleted() ? 1 : 0, __ID_isFlaggedForDeletion, entity.isFlaggedForDeletion() ? 1 : 0,
                0, 0, 0, 0);
